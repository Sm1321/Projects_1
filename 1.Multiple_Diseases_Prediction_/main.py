...
file_path1 = "Models/trained_model_diabetes.sav"
with open(file_path1, 'rb') as file:
    diabetes_model = pickle.load(file)

file_path2 = "Models/trained_model_Heart_Disease_Prediction.sav"
with open(file_path2, 'rb') as file:
    heart_disease_model = pickle.load(file)

file_path3 = "Models/trained_model_Parkinson.sav"
with open(file_path3, 'rb') as file:
    parkinson_disease_model = pickle.load(file)


file_path4 = "Models/scaler_parkinsons.pkl"
...
if(selected =='Parkinsons Disease Prediction'):
    ...
    if st.button("Parkinson's Test Result"):
     ...
     user_input = [float(x) for x in user_input]
     input_scaled_data = scaler_parkinson.transform(user_input)
